...
<div id="container">
    <div id="hd">
        <div class="hd-top">
<!--            <image src="../../admin/img/skin_/xuanyuandi.png" style="width:197px;height:50px;"></image>-->
    ...
    <div id="ft" class="ue-clear">
        <div class="ft1 ue-clear">
            <i class="ft-icon1"></i> <span>轩辕帝教育 Xuan-yuan-di-Education <a href="#" target="_blank" title="1605PHP-SH">1605PHP-SH</a> - Not forget </span>
        </div>
        <div class="ft2 ue-clear">
            <span>Xuan-Yuan-Di@</span>
            <em>1605PHP-SH</em>
            <i class="ft-icon2"></i>
        </div>
    </div>
